...
if(isset($_POST['edit_brand'])){
    ...
    if($result_brand){
        echo "<script>alert('Brand is been update successfully')</script>";
        echo "<script>window.open('./index.php?view_brands.php','self')</script>";
    }
}
...
<div class="container mt-3">
    ...
    <form action="" method="post" class=text-center>
        <div class="form-outline mb-4 w-50 m-auto">
            <label for="brand_title" class="form-lable">Category Title</label>
